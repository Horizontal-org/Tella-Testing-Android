...
public class AudioConstants {
    ...
    public static final String RECORD_NAME_PENCIL_ICON = "id:rec_name";
    public static final String TITLE_AUDIO_RECORDING_INPUT = "org.hzontal.tella:id/renameEditText";
