...
public class ServersConstants {
    ...
    public static final String SERVER_SELECTION_SHEET = "xpath://*[contains(@resource-id,\"sheet_one_btn\")]//*[contains(@resource-id,\"sheet_textView\")]";
    public static final String SERVER_OPTION_ODK = "xpath://*[contains(@resource-id,\"sheet_one_btn\")]//*[contains(@resource-id,\"sheet_textView\")]";
    public static final String SERVER_OPTION_TELLA_WEB = "xpath://*[contains(@resource-id,\"sheet_two_btn\")]//*[contains(@resource-id,\"sheet_textView\")]";
    public static final String SERVER_OPTION_UWAZI = "xpath://*[contains(@resource-id,\"sheet_three_btn\")]//*[contains(@resource-id,\"sheet_textView\")]";
    public static final String SERVER_OPTION_GOOGLE_DRIVE = "xpath://*[contains(@resource-id,\"sheet_four_activated_btn\")]//*[contains(@resource-id,\"sheet_textView\")]";
    public static final String SERVER_OPTION_DROPBOX = "xpath://*[contains(@resource-id,\"sheet_five_activated_btn\")]//*[contains(@resource-id,\"sheet_textView\")]";
    public static final String SERVER_OPTION_NEXTCLOUD = "xpath://*[contains(@resource-id,\"sheet_six_activated_btn\")]//*[contains(@resource-id,\"sheet_textView\")]";
