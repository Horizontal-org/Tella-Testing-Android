...
public class AudioService {
    ...
    public static void clickRecOption() {
        ...
        GenericService.clickElementByCoordinates(AudioConstants.REC_OPTION);
    }

    public static void clickMicrophoneIcon(){
        MobileActionManager.waitVisibility(AudioConstants.MICROPHONE_ICON);
        GenericService.clickElementByCoordinates(AudioConstants.MICROPHONE_ICON);
    }

    public static void clickPencilIcon() {
        MobileActionManager.waitVisibility(AudioConstants.RECORD_NAME_PENCIL_ICON);
        GenericService.clickElementByCoordinates(AudioConstants.RECORD_NAME_PENCIL_ICON);
    }
    ...
    public static void clickOkButton() {
        ...
        GenericService.clickElementByCoordinates(AudioConstants.OK_BUTTON);
    ...
    public static void clickStopOption2() {
        ...
        nameChanged = MobileActionManager.getText(AudioConstants.RECORD_NAME_PENCIL_ICON);
        GenericService.clickElementByCoordinates(AudioConstants.RECORD_AUDIO);
    }
    ...
    public static void acceptPermissions() {
        try {
            ...
            List<WebElement> elems = driver.findElements(By.id(AudioConstants.PERMISSIONS_MESSAGE));
            if (elems.size() > 0) {
    ...
    public static void clickPause() {
        for (int i = 0; i < 3; i++) {
            try {
                ...
                GenericService.clickElementByCoordinates(AudioConstants.PAUSE_BUTTON);
